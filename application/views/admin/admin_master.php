                ...
                <div id="sidebar-left" class="span2">
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            <li><a href="<?php echo  base_url()?>index.php/Super_Admin/"><i class="icon-bar-chart"></i><span class="hidden-tablet"> Dashboard</span></a></li>	
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/add_category"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Category</span></a></li>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/manage_category"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Category</span></a></li>
                                    <li>
                                </ul>	
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/add_manufacture"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/manage_manufacture"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage Manufacture</span></a></li>
                                    <li>
                                </ul>	
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/add_product"><i class="icon-file-alt"></i><span class="hidden-tablet"> Add product</span></a></li>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/manage_product"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage product</span></a></li>
                                    <li>
                                </ul>	
                            </li>
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/add_slider"><i class="icon-file-alt"></i><span class="hidden-tablet">add slider</span></a></li>
                                   <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/manage_slider"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage slider</span></a></li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/add_banner"><i class="icon-file-alt"></i><span class="hidden-tablet">add banner</span></a></li>
                                   <li><a class="submenu" href="<?php echo  base_url()?>index.php/Super_Admin/manage_banner"><i class="icon-file-alt"></i><span class="hidden-tablet"> Manage banner</span></a></li>
                            ...
                            <li><a href="<?php echo  base_url()?>index.php/Super_Admin/manage_order"><i class="icon-envelope"></i><span class="hidden-tablet">Customer Order </span></a></li>
                            <li><a href="<?php echo  base_url()?>index.php/Super_Admin/task"><i class="icon-tasks"></i><span class="hidden-tablet"> Tasks</span></a></li>
