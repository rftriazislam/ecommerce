...
<!--[if (gt IE 9)|!(IE)]><!--><html lang="en"><!--<![endif]-->
    ...
    <body>
                    ...
                    <div class="container">
                        <div class="row clearfix">
                            ...
                            if ($customer_id == NULL) {
                                ...
                                <div class="col-lg-4 col-md-4 col-sm-3 t_xs_align_c">
                                    <p class="f_size_small"> Welcome &nbsp;  <b> <?php echo $this->session->userdata('customer_name') ?> </b>&nbsp; or &nbsp; <a href="<?php echo base_url() ?>Checkout/customer_logout" >Logout</a> </p>
                                </div>
                            <?php } ?>
                    ...
                    <section class="menu_wrap type_2 relative clearfix t_xs_align_c m_bottom_20">
                        ...
                        <nav role="navigation" class="f_left f_xs_none d_xs_none t_xs_align_l">	
                            <ul class="horizontal_list main_menu clearfix">
                                <li class="current relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url() ?>Welcome" class="tr_delay_hover color_light tt_uppercase"><b>Home</b></a></li>

                                <li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url() ?>Welcome/category" class="tr_delay_hover color_light tt_uppercase"><b>category</b></a>
                                    <div class="sub_menu_wrap top_arrow d_xs_none type_2 tr_all_hover clearfix r_corners">
                                        <ul class="sub_menu">
                                            <?php
                                            foreach ($all_category as $V_category) {
                                                ?>
                                                <li><a class="color_dark tr_delay_hover" href="<?php echo base_url() ?>Welcome/product_page"> <?php echo $V_category->category_name ?></a></li>
                                            <?php } ?>
                                        </ul>
                                    </div></li>
                                ...
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url() ?>Welcome/blog" class="tr_delay_hover color_light tt_uppercase"><b>Blog</b></a></li>
                                <li class="relative f_xs_none m_xs_bottom_5"><a href="<?php echo base_url() ?>Welcome/feature" class="tr_delay_hover color_light tt_uppercase"><b>feature</b></a></li>
                            ...
                            <li class="m_left_5 relative container3d" id="shopping_button">
                                ...
                                <div class="shopping_cart top_arrow tr_all_hover r_corners">
                                    ...
                                    <ul class="products_list">
                                        ...
                                        foreach ($this->cart->contents() as $items) {
                                            ...
                                            <li>
                                                <div class="clearfix">
                                                    <!--product image-->
                                                    <img class="f_left m_right_10" width="80px" src="<?php echo base_url() . $items['image'] ?>" alt="">
                                                    <!--product description-->
                                    ...
                                    <ul class="total_price bg_light_color_1 t_align_r color_dark">
                                        ...
                                        <li class="m_bottom_10">Discount: <span class="f_size_large sc_price t_align_l d_inline_b m_left_15"></span></li>
                            ...
                            <div class="flexslider animate_ftr long">
                                <ul class="slides">
                                    ...
                                    foreach ($all_slider as $V_slider) {
                                        ...
                                        <li>
                                            <img src="<?php echo base_url() . $V_slider->slider_image ?>"  alt="" data-custom-thumb="<?php echo base_url() . $V_slider->slider_image ?>">
                                            <section class="slide_caption t_align_c d_xs_none">
                                                ...
                                                <a href="<?php echo base_url() ?>Welcome/product_details" role="button" class="d_sm_inline_b button_type_4 bg_scheme_color color_light r_corners tt_uppercase tr_all_hover">Buy Now</a>
                                            </section>
                                        </li>
                                    <?php } ?>
                                </ul>
        ...
        <script type="text/javascript" src="../../s7.addthis.com/<?php echo base_url(); ?>asset/front_end/js/300/addthis_widget.js#pubid=xa-5306f8f674bfda4c"></script>
    </body>
