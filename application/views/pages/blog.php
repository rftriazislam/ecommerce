            ...
            <section class="col-lg-9 col-md-9 col-sm-9">
                ...
                <article class="m_bottom_25">
                    <a href="#" class="d_block photoframe r_corners wrapper shadow m_bottom_25">
                        <img src="<?php echo base_url()?>asset/front_end/images/blog_img_4.jpg" class="tr_all_long_hover" alt="">
                    </a>
                ...
                <article class="m_bottom_20 clearfix">
                    <a href="#" class="photoframe d_block d_xs_inline_b f_xs_none wrapper shadow f_left m_right_20 m_bottom_10 r_corners">
                        <img src="<?php echo base_url()?>asset/front_end/images/blog_img_5.jpg" class="tr_all_long_hover" alt="">
                    </a>
                ...
                <article class="m_bottom_20 clearfix">
                    <a href="#" class="photoframe d_block d_xs_inline_b f_xs_none wrapper shadow f_left m_right_20 m_bottom_10 r_corners">
                        <img src="<?php echo base_url()?>asset/front_end/images/blog_img_6.jpg" class="tr_all_long_hover" alt="">
                    </a>
                    <div class="mini_post_content">
                ...
                <article class="m_bottom_20 clearfix">
                    <a href="#" class="photoframe d_block d_xs_inline_b f_xs_none wrapper shadow f_left m_right_20 r_corners m_bottom_10">
                        <img src="<?php echo base_url()?>asset/front_end/images/blog_img_7.jpg" class="tr_all_long_hover" alt="">
                    </a>
                    <div class="mini_post_content">
                        <h4 class="m_bottom_5"><a href="#" class="color_dark fw_medium">Cursus eleifend, elit aenean</a></h4>
                        <p class="f_size_medium m_bottom_10">15 January, 2013, <a href="#" class="color_dark">15 comments</a>, on <a href="#" class="color_dark">New Arrivals</a></p>
                        <hr>
                        <div class="rating_min_article">
                            <p class="f_size_medium d_inline_middle d_sm_block d_xs_inline_middle">Rate this item</p>
                            <!--rating-->
                ...
                <article class="m_bottom_20 clearfix">
                    <a href="#" class="photoframe d_block d_xs_inline_b f_xs_none wrapper shadow f_left m_right_20 r_corners m_bottom_10">
                        <img src="<?php echo base_url()?>asset/front_end/images/blog_img_8.jpg" class="tr_all_long_hover" alt="">
                    </a>
                    <div class="mini_post_content">
                ...
                <figure class="widget shadow r_corners wrapper m_bottom_30">
                    ...
                    <div class="widget_content">
                        <article class="clearfix m_bottom_15">
                            <img src="<?php echo base_url()?>asset/front_end/images/article_img_1.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                            <a href="#" class="color_dark d_block bt_link p_vr_0">Aliquam erat volutpat.</a>
                            <p class="f_size_medium">50 comments</p>
                        </article>
                        <hr class="m_bottom_15">
                        <article class="clearfix m_bottom_15">
                            <img src="<?php echo base_url()?>asset/front_end/images/article_img_2.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                        ...
                        <article class="clearfix m_bottom_5">
                            <img src="<?php echo base_url()?>asset/front_end/images/article_img_3.jpg" alt="" class="f_left m_right_15 m_sm_bottom_10 f_sm_none f_xs_left m_xs_bottom_0">
                        ...
                        <div class="specials_carousel">
                            ...
                            <div class="specials_item">
                                <a href="#" class="d_block d_xs_inline_b wrapper m_bottom_20">
                                    <img class="tr_all_long_hover" src="<?php echo base_url()?>asset/front_end/images/product_img_6.jpg" alt="">
                                </a>
                            ...
                            <div class="specials_item">
                                <a href="#" class="d_block d_xs_inline_b wrapper m_bottom_20">
                                    <img class="tr_all_long_hover" src="<?php echo base_url()?>asset/front_end/images/product_img_7.jpg" alt="">
                                </a>
                            ...
                            <div class="specials_item">
                                <a href="#" class="d_block d_xs_inline_b wrapper m_bottom_20">
                                    <img class="tr_all_long_hover" src="<?php echo base_url()?>asset/front_end/images/product_img_5.jpg" alt="">
                                </a>
                                <h5 class="m_bottom_10"><a href="#" class="color_dark">Aliquam erat volutpat</a></h5>
                                <p class="f_size_large m_bottom_15"><s>$79.00</s> <span class="scheme_color">$36.00</span></p>
                                <button class="button_type_4 mw_sm_0 r_corners color_light bg_scheme_color tr_all_hover m_bottom_5">Add to Cart</button>
