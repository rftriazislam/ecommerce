<div class="page_content_offset">
    <div class="container">
        ...
        <ul class="horizontal_list clearfix tt_uppercase isotope_menu f_size_ex_large">
            ...
            ?>
            <li class="active m_right_5 m_bottom_10 m_xs_bottom_5 animate_ftr"><a href="<?php echo base_url()?>Welcome/category_product/<?php echo $v_cate->category_id?>"><button class="button_type_2 bg_light_color_1 r_corners tr_delay_hover tt_uppercase box_s_none" data-filter="*"><?php echo $v_cate->category_name ?></button></a></li>
